(function() {
  var RedisSessions, SessionHandler, SessionObject, signature,
  ...
  module.exports = SessionHandler = (function() {
    ...
    SessionHandler.prototype._setCookie = function(req) {
      ...
      return function() {
        ...
        isNew = req._unsignedCookie !== req.sessionID;
        ...
        _signed = "s:" + signature.sign(req.sessionID, _this.secret);
