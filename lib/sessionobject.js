(function() {
  ...
  module.exports = Session = (function() {
    ...
    Session.prototype.attributes = function(withCookie) {
      var _k, _ref, _ret, _v;
      if (withCookie == null) {
        withCookie = true;
      }
      ...
      for (_k in this) {
        _v = this[_k];
        if (_k !== "_meta" && ((_ref = typeof _v) === "string" || _ref === "number" || _ref === "boolean")) {
          _ret[_k] = _v;
        }
      }
      return _ret;
    ...
    Session.prototype.regenerate = function(cb) {
      ...
      this.handler.regenerate(this.req, fn);
      return this;
    };

    Session.prototype.hash = function() {
      return crc32.signed(JSON.stringify(this.attributes(false)));
    };
    ...
    Session.prototype.activity = function() {
      ...
      dt = args[0];
      this.handler.getAppActivity(this.req, dt, cb);
    };
    ...
    Session.prototype.soapp = function() {
      ...
      args = 2 <= arguments.length ? __slice.call(arguments, 0, _i = arguments.length - 1) : (_i = 0, []), cb = arguments[_i++];
      dt = args[0];
      this.handler.getAppSessions(this.req, dt, cb);
    };
